...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="../../public/backend/assets/assets/images/neptune.png" />
            ...
            <div class="logo">
                ...
                <div class="sidebar-user-switcher user-activity-online">
                    <a href="#">
                        ...
                        <?php if($user['image'] == 'payel.jpg') : ?>
                        <img style="width: 50px; height:50px; border-radius:50%;" src="../../public/uplode/picture/<?= $user['image']?>">
                        <?php else : ?>
                        <img style="width: 50px; height:50px; border-radius:50%;" src="../../public/uplode/profile/<?= $user['image']?>">
                        <?php endif; ?>
