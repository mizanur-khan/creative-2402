        ...
        <div class="app-auth-container">
            ...
            <div class="alert alert-custom" role="alert">
                 ...
                 <span class="alert-title">
                    <?php echo $_SESSION['register_complete'] ?>
                 </span>
                 <span class="alert-text">
                    <?php echo $_SESSION['register_name'] ?>
                 </span>
                </div>
                </div>
            ...
            <div class="auth-credentials m-b-xxl">
                ...
                <input name="email" type="text" class="form-control m-b-md" id="signInEmail" aria-describedby="signInEmail"
                 placeholder="example@neptune.com" value="<?= (isset($_SESSION['register_email'])) ? $_SESSION
                 ['register_email'] : ''; unset($_SESSION['register_email']) ?>">
            ...
            <div class="auth-submit">
                <button type="submit" name="loginbtn" class="btn btn-primary">Sign In</a>
            </div>
            </form>
